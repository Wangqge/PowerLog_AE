...
import socialite.tables.RemoteBodyTable_6_1_int_int_groupby0_id9;
...
public final class VisitorComp_9 extends VisitorImpl implements Runnable {
    private RemoteBodyTable_6_1_int_int_groupby0_id9 $_remoteBodyTable_6_10;
    ...
    private Remote_Comp_9_int_int_groupby0_id2[] remoteTable_head=new Remote_Comp_9_int_int_groupby0_id2[2];
;
    public  VisitorComp_9(int _$epochId, int _$ruleId, RemoteBodyTable_6_1_int_int_groupby0_id9 _$$_remoteBodyTable_6_10, Edge_int_int_nest1_indexby0_range0to875713_groupby0_id0 _$$_edge1, Comp_int_int_indexby0_range0to875713_groupby0_id2 $$headTable, SRuntime _$runtime, int _$firstTableIdx) {
        $_remoteBodyTable_6_10 = _$$_remoteBodyTable_6_10;
        $_edge1 = _$$_edge1;
        $headTable=$$headTable;
        $epochId=_$epochId;
        $ruleId=_$ruleId;
    ...
    public void run() {
        do {
          $currentPredicate=0;
          $_remoteBodyTable_6_10.iterate(this);
        } while (false);;
        ...
        do {
          switch ($currentPredicate) {
              ...
              if ($sliceMap.isLocal(2,n)) {
                  ...
                  int $_slice_14=$sliceMap.getRangeIndex(2,0,n);
                  try {
                      $lockMap.lock(2, $_slice_14);
                      if (!_$$headTable.contains(n)) {
                          $aggrVar=i; ;
                      ...
                      $lockMap.unlock(2, $_slice_14);
                  };
                  if ($isUpdated) {
                      {getDeltaTable().update(n, $aggrVar);};
                  };};
              } else {
                  Remote_Comp_9_int_int_groupby0_id2 _$remoteT;
    ...
    public Remote_Comp_9_int_int_groupby0_id2 getRemoteTable_head(int _$rangeOrHash) {
        int _$machineIdx=$sliceMap.machineIndexFor(2, _$rangeOrHash);
        Remote_Comp_9_int_int_groupby0_id2 _$remoteT=remoteTable_head[_$machineIdx];
        if (_$remoteT==null) {
            _$remoteT=(Remote_Comp_9_int_int_groupby0_id2)TmpTablePool.__get(worker.id(),Remote_Comp_9_int_int_groupby0_id2.class);
    ...
    public String toString() {
        String str="Comp(n,$Builtin.min(i)) :- RemoteBodyTable_6_1(p,i),Edge(p,n). epoch:"+$epochId;
        return str;
    }
