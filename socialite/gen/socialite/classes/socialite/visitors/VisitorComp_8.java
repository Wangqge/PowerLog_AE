...
import socialite.tables.Remote_Comp_6_int_int_groupby0_id2;
import socialite.tables.Comp_int_int_indexby0_range0to875713_groupby0_id2;


public final class VisitorComp_8 extends VisitorImpl implements Runnable {
    private Remote_Comp_6_int_int_groupby0_id2 $_remote_Comp_60;
...
;
    public  VisitorComp_8(int _$epochId, int _$ruleId, Remote_Comp_6_int_int_groupby0_id2 _$$_remote_Comp_60, Comp_int_int_indexby0_range0to875713_groupby0_id2 $$headTable, SRuntime _$runtime, int _$firstTableIdx) {
        $_remote_Comp_60 = _$$_remote_Comp_60;
        $headTable=$$headTable;
        $epochId=_$epochId;
        $ruleId=_$ruleId;
        $runtime=_$runtime;
    ...
    public boolean visit(int _0, int _1) {
        do {
          switch ($currentPredicate) {
              ...
              int $_slice_13=$sliceMap.getRangeIndex(2,0,$0$priv);
              try {
                  $lockMap.lock(2, $_slice_13);
                  if (!_$$headTable.contains($0$priv)) {
                      $aggrVar=$1$priv; ;
    ...
    public String toString() {
        String str="Comp($0$priv,$Builtin.min($1$priv)) :- Remote_Comp_6($0$priv,$1$priv). epoch:"+$epochId;
        return str;
    }
