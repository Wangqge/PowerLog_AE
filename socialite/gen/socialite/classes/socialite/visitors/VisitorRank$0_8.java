...
;
    public  VisitorRank$0_8(int _$epochId, int _$ruleId, Double _$$const3, Integer _$$const4, Node_int_indexby0_range0to875713_groupby0_id2 _$$_node0, Rank$0_int_double_indexby0_range0to875713_groupby0_id3 $$headTable, SRuntime _$runtime, int _$firstTableIdx) {
        $const3=_$$const3;
        $const4=_$$const4;
        $_node0 = _$$_node0;
        $headTable=$$headTable;
    ...
    public boolean visit(int _0) {
        do {
          switch ($currentPredicate) {
              ...
              int $_slice_11=$sliceMap.getRangeIndex(3,0,n);
              try {
                  $lockMap.lock(3, $_slice_11);
    ...
    public String toString() {
        String str="Rank$0(n,$Builtin.sum(r)) :- Node(n),r=(0.2/875713). epoch:"+$epochId;
        return str;
    }
