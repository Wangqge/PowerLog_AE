...
public final class VisitorPATH$0_6 extends VisitorImpl implements Runnable {
    ...
    private Remote_PATH$0_6_int_int_groupby0_id1[] remoteTable_head=new Remote_PATH$0_6_int_int_groupby0_id1[2];
;
    public  VisitorPATH$0_6(int _$epochId, int _$ruleId, Integer _$$const4, Edge_int_int_int_nest1_indexby0_range0to875713_groupby0_id0 _$$_edge0, PATH$0_int_int_indexby0_range0to875713_groupby0_id1 $$headTable, SRuntime _$runtime, int _$firstTableIdx) {
        $const4=_$$const4;
        $_edge0 = _$$_edge0;
        $headTable=$$headTable;
        $epochId=_$epochId;
        ...
        do {
          switch ($currentPredicate) {
              ...
              if ($sliceMap.isLocal(1,t)) {
                  ...
                  int $_slice_9=$sliceMap.getRangeIndex(1,0,t);
                  try {
                      $lockMap.lock(1, $_slice_9);
                      if (!_$$headTable.contains(t)) {
                          $aggrVar=d; ;
                      ...
                      $lockMap.unlock(1, $_slice_9);
                  };
                  if ($isUpdated) {
                      {;};
                  };};
              } else {
                  Remote_PATH$0_6_int_int_groupby0_id1 _$remoteT;
    ...
    public Remote_PATH$0_6_int_int_groupby0_id1 getRemoteTable_head(int _$rangeOrHash) {
        int _$machineIdx=$sliceMap.machineIndexFor(1, _$rangeOrHash);
        Remote_PATH$0_6_int_int_groupby0_id1 _$remoteT=remoteTable_head[_$machineIdx];
        if (_$remoteT==null) {
            _$remoteT=(Remote_PATH$0_6_int_int_groupby0_id1)TmpTablePool.get(worker.id(),Remote_PATH$0_6_int_int_groupby0_id1.class);
    ...
    public String toString() {
        String str="PATH$0(t,$Builtin.min(d)) :- Edge(0,t,d). epoch:"+$epochId;
        return str;
    }
