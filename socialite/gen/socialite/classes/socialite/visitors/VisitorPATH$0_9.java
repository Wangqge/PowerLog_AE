...
import socialite.tables.Remote_PATH$0_7_int_int_groupby0_id1;
import socialite.tables.PATH$0_int_int_indexby0_range0to875713_groupby0_id1;


public final class VisitorPATH$0_9 extends VisitorImpl implements Runnable {
    private Remote_PATH$0_7_int_int_groupby0_id1 $_remote_PATH$0_70;
...
;
    public  VisitorPATH$0_9(int _$epochId, int _$ruleId, Remote_PATH$0_7_int_int_groupby0_id1 _$$_remote_PATH$0_70, PATH$0_int_int_indexby0_range0to875713_groupby0_id1 $$headTable, SRuntime _$runtime, int _$firstTableIdx) {
        $_remote_PATH$0_70 = _$$_remote_PATH$0_70;
        $headTable=$$headTable;
        $epochId=_$epochId;
        $ruleId=_$ruleId;
        $runtime=_$runtime;
    ...
    public void run() {
        do {
          $currentPredicate=0;
          $_remote_PATH$0_70.iterate(this);
        } while (false);;
    }
    ...
    public boolean visit(int _0, int _1) {
        do {
          switch ($currentPredicate) {
              ...
              int $_slice_12=$sliceMap.getRangeIndex(1,0,$0$priv);
              try {
                  $lockMap.lock(1, $_slice_12);
                  if (!_$$headTable.contains($0$priv)) {
                      $aggrVar=$1$priv; ;
    ...
    public String toString() {
        String str="PATH$0($0$priv,$Builtin.min($1$priv)) :- Remote_PATH$0_7($0$priv,$1$priv). epoch:"+$epochId;
        return str;
    }
