...
public final class VisitorComp_5 extends VisitorImpl implements Runnable {
    private Comp_int_int_indexby0_range0to875713_groupby0_id2 $_comp0;
    ...
    private Remote_Comp_5_int_int_groupby0_id2[] remoteTable_head=new Remote_Comp_5_int_int_groupby0_id2[2];
;
    public  VisitorComp_5(int _$epochId, int _$ruleId, Comp_int_int_indexby0_range0to875713_groupby0_id2 _$$_comp0, Edge_int_int_nest1_indexby0_range0to875713_groupby0_id0 _$$_edge1, Comp_int_int_indexby0_range0to875713_groupby0_id2 $$headTable, SRuntime _$runtime, int _$firstTableIdx) {
        $_comp0 = _$$_comp0;
        $_edge1 = _$$_edge1;
        $headTable=$$headTable;
        $epochId=_$epochId;
    ...
    public void run() {
        do {
          $currentPredicate=0;
          $_comp0.iterate_range_0($sliceMap.getRange(2,0,$firstTableIdx)[0],$sliceMap.getRange(2,0,$firstTableIdx)[1],this);
        } while (false);;
        ...
        do {
          switch ($currentPredicate) {
              ...
              if ($sliceMap.isLocal(2,n)) {
                  ...
                  int $_slice_10=$sliceMap.getRangeIndex(2,0,n);
                  try {
                      $lockMap.lock(2, $_slice_10);
                      if (!_$$headTable.contains(n)) {
                          $aggrVar=i; ;
                      ...
                      $lockMap.unlock(2, $_slice_10);
                  };
                  if ($isUpdated) {
                      {getDeltaTable().update(n, $aggrVar);};
                  };};
              } else {
                  Remote_Comp_5_int_int_groupby0_id2 _$remoteT;
    ...
    public Remote_Comp_5_int_int_groupby0_id2 getRemoteTable_head(int _$rangeOrHash) {
        int _$machineIdx=$sliceMap.machineIndexFor(2, _$rangeOrHash);
        Remote_Comp_5_int_int_groupby0_id2 _$remoteT=remoteTable_head[_$machineIdx];
        if (_$remoteT==null) {
            _$remoteT=(Remote_Comp_5_int_int_groupby0_id2)TmpTablePool.get(worker.id(),Remote_Comp_5_int_int_groupby0_id2.class);
    ...
    public Delta_Comp_int_int_groupby0_id2 getDeltaTable() {
        if (delta$Comp==null) {
            delta$Comp=(Delta_Comp_int_int_groupby0_id2)TmpTablePool.get(getWorkerId(),Delta_Comp_int_int_groupby0_id2.class,0);
    ...
    public String toString() {
        String str="Comp(n,$Builtin.min(i)) :- Comp(p,i),Edge(p,n). epoch:"+$epochId;
        return str;
    }
