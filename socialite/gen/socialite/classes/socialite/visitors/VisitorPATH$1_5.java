...
import socialite.tables.Remote_PATH$1_3_int_int_groupby0_id2;
import socialite.tables.PATH$1_int_int_indexby0_range0to875713_groupby0_id2;


public final class VisitorPATH$1_5 extends VisitorImpl implements Runnable {
    private Remote_PATH$1_3_int_int_groupby0_id2 $_remote_PATH$1_30;
...
;
    public  VisitorPATH$1_5(int _$epochId, int _$ruleId, Remote_PATH$1_3_int_int_groupby0_id2 _$$_remote_PATH$1_30, PATH$1_int_int_indexby0_range0to875713_groupby0_id2 $$headTable, SRuntime _$runtime, int _$firstTableIdx) {
        $_remote_PATH$1_30 = _$$_remote_PATH$1_30;
        $headTable=$$headTable;
        $epochId=_$epochId;
        $ruleId=_$ruleId;
        $runtime=_$runtime;
    ...
    public void run() {
        do {
          $currentPredicate=0;
          $_remote_PATH$1_30.iterate(this);
        } while (false);;
    }
    ...
    public boolean visit(int _0, int _1) {
        do {
          switch ($currentPredicate) {
              ...
              int $_slice_8=$sliceMap.getRangeIndex(2,0,$0$priv);
              try {
    ...
    public String toString() {
        String str="PATH$1($0$priv,$Builtin.min($1$priv)) :- Remote_PATH$1_3($0$priv,$1$priv). epoch:"+$epochId;
        return str;
    }
