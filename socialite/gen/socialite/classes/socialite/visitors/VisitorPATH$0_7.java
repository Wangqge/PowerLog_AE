...
public final class VisitorPATH$0_7 extends VisitorImpl implements Runnable {
    private PATH$1_int_int_indexby0_range0to875713_groupby0_id2 $_pATH$10;
    ...
    private Remote_PATH$0_7_int_int_groupby0_id1[] remoteTable_head=new Remote_PATH$0_7_int_int_groupby0_id1[2];
;
    public  VisitorPATH$0_7(int _$epochId, int _$ruleId, PATH$1_int_int_indexby0_range0to875713_groupby0_id2 _$$_pATH$10, Edge_int_int_int_nest1_indexby0_range0to875713_groupby0_id0 _$$_edge1, PATH$0_int_int_indexby0_range0to875713_groupby0_id1 $$headTable, SRuntime _$runtime, int _$firstTableIdx) {
        $_pATH$10 = _$$_pATH$10;
        $_edge1 = _$$_edge1;
        $headTable=$$headTable;
        $epochId=_$epochId;
    ...
    public void run() {
        do {
          $currentPredicate=0;
          $_pATH$10.iterate_range_0($sliceMap.getRange(2,0,$firstTableIdx)[0],$sliceMap.getRange(2,0,$firstTableIdx)[1],this);
        } while (false);;
        ...
        do {
          switch ($currentPredicate) {
              ...
              if ($sliceMap.isLocal(1,t)) {
                  ...
                  int $_slice_11=$sliceMap.getRangeIndex(1,0,t);
                  try {
                      $lockMap.lock(1, $_slice_11);
                      if (!_$$headTable.contains(t)) {
                          $aggrVar=d; ;
                      ...
                      $lockMap.unlock(1, $_slice_11);
                  };
                  if ($isUpdated) {
                      {;};
                  };};
              } else {
                  Remote_PATH$0_7_int_int_groupby0_id1 _$remoteT;
                  int _$machineIdx=$sliceMap.machineIndexFor(1,t);
    ...
    public Remote_PATH$0_7_int_int_groupby0_id1 getRemoteTable_head(int _$rangeOrHash) {
        int _$machineIdx=$sliceMap.machineIndexFor(1, _$rangeOrHash);
        Remote_PATH$0_7_int_int_groupby0_id1 _$remoteT=remoteTable_head[_$machineIdx];
        if (_$remoteT==null) {
            _$remoteT=(Remote_PATH$0_7_int_int_groupby0_id1)TmpTablePool.get(worker.id(),Remote_PATH$0_7_int_int_groupby0_id1.class);
    ...
    public String toString() {
        String str="PATH$0(t,$Builtin.min(d)) :- PATH$1(s,d1),Edge(s,t,d2),d=(d1+d2). epoch:"+$epochId;
        return str;
    }
