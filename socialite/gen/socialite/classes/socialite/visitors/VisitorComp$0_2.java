...
import socialite.tables.Comp$0_int_int_indexby0_range0to875713_groupby1_id2;


public final class VisitorComp$0_2 extends VisitorImpl implements Runnable {
    private Nodes_int_indexby0_range0to875713_groupby0_id1 $_nodes0;
    private Comp$0_int_int_indexby0_range0to875713_groupby1_id2 $headTable;
...
;
    public  VisitorComp$0_2(int _$epochId, int _$ruleId, Nodes_int_indexby0_range0to875713_groupby0_id1 _$$_nodes0, Comp$0_int_int_indexby0_range0to875713_groupby1_id2 $$headTable, SRuntime _$runtime, int _$firstTableIdx) {
        $_nodes0 = _$$_nodes0;
        $headTable=$$headTable;
        $epochId=_$epochId;
        $ruleId=_$ruleId;
    ...
    public boolean visit(int _0) {
        do {
          switch ($currentPredicate) {
              ...
              Comp$0_int_int_indexby0_range0to875713_groupby1_id2 _$$headTable=$headTable;
    ...
    public String toString() {
        String str="Comp$0(n,n) :- Nodes(n). epoch:"+$epochId;
        return str;
    }
