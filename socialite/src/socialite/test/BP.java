...
public class BP {
    ...
    // 0       1             2    3    4
    //single node-count edge-path  parameter  iter-num
    //dist   node-count   edge-path parameter  iter-num
    ...
    public static void main(String[] args) throws FileNotFoundException, InterruptedException {
        STGroup stg = new MySTGroupFile(PageRank.class.getResource("BP.stg"),
                "UTF-8", '<', '>');
        stg.load();
        if (args[0].equals("single")) {
            ...
            st.add("P", Integer.parseInt(args[3]));//web-BerkStan_fix
...
//            System.out.println(vals[0]);
	...
	System.out.println(args[2]+" "+args[3]);
            ...
            st.add("P", Integer.parseInt(args[3]));
            String init = st.render();
            System.out.println(init);
