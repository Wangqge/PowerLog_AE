...
if sys.argv[1] == 'start':
   ...
   %s/bin/java -Xmx26G -ea \\
    ...
    prog_args = 'dist %d %s%s%s  %s%s%s %d'%(2302925, 'hdfs://',MASTER_HOSTNAME,':9000/experiment/flickr/node.txt','hdfs://',MASTER_HOSTNAME,':9000/experiment/flickr/edge.txt',10)
