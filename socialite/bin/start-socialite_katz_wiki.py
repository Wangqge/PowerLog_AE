...
if sys.argv[1] == 'start':
   ...
   %s/bin/java -Xmx26G -ea \\
    ...
    prog_args = 'dist %d %s%s%s %s%s%s %f %d'%(12150976,'hdfs://',MASTER_HOSTNAME,':9000/experiment/wiki/edge.txt','hdfs://',MASTER_HOSTNAME,':9000/experiment/wiki/node_katz.txt',0.01,40)
