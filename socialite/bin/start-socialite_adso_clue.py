...
if sys.argv[1] == 'start':
   ...
   %s/bin/java -Xmx26G -ea \\
    ...
    prog_args = 'dist %d %s%s%s %s%s%s %d %d'%(10000000,'hdfs://',MASTER_HOSTNAME,':9000/experiment/clue/edge.txt','hdfs://',MASTER_HOSTNAME,':9000/experiment/clue/node_adsorption.txt',200,40)
