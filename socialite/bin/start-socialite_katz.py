...
if sys.argv[1] == 'start':
   ...
   %s/bin/java -Xmx26G -ea \\
    ...
    prog_args = 'dist %d %s%s%s %s%s%s %f %d'%(875713,'hdfs://',MASTER_HOSTNAME,':9000/experiment/google/edge.txt','hdfs://',MASTER_HOSTNAME,':9000/experiment/google/node_katz.txt',0.01,20)
