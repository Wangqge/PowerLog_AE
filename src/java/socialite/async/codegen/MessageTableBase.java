...
public abstract class MessageTableBase implements Cloneable {
    ...
    public MessageTableBase clone() throws CloneNotSupportedException{
        return (MessageTableBase)super.clone();
    }
