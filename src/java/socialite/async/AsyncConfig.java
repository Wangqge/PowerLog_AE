...
//CODE BY WANG
    ...
    public static void updateMessageUpdateThreshold(int  _messageUpdateThreshold){
        asyncConfig.messageTableUpdateThreshold=_messageUpdateThreshold;
//CODE BY WANG
    ...
    public double  getDumpling() { return dumpling;}
    ...
    public enum EngineType {
        ASYNC, SEMI_ASYNC, SYNC, AUTO, BLOCK_ASYNC
    }
    ...
    public static class Builder {
        ...
        public Builder setParameter(double parameter) {
            this.parameter = parameter;
            return this;
        }
        public Builder setDumpling(double dumpling) {
            this.dumpling = dumpling;
            return this;
        }
        public Builder settuning(boolean tuning) {
            this.tuning = tuning;
            return this;
        }
        ...
        public AsyncConfig build() {
            ...
            asyncConfig.tuning = tuning;
            asyncConfig.parameter = parameter;
            asyncConfig.dumpling = dumpling;
        ...
        configMap.forEach((key, val) -> {
            switch (key) {
                ...
                case "CHECK_TYPE":
                    ...
                    break;
                case "PARAMETER":
                    asyncConfig.setParameter(Double.parseDouble(val));
                    break;
                case "DUMPLING":
                    asyncConfig.setDumpling(Double.parseDouble(val));
                    break;
                case "TUNNING":
                    switch(val){
                        case "TRUE":
                            asyncConfig.settuning(true);
                            break;
                        case "FALSE":
                            asyncConfig.settuning(false);
                            break;
                        default:
                            throw new SociaLiteException("unknown TUNNING OPERATION: " + val);
                    }
                    break;
                case "CHECK_COND":
                    switch (val) {
                ...
                case "ENGINE_TYPE":
                    ...
                    else if (val.equals("BLOCK_ASYNC"))
                        asyncConfig.setEngineType(EngineType.BLOCK_ASYNC);
                    else throw new SociaLiteException("unknown val: " + val);
                    break;
